...
![設定画面の接続設定を選ぶ](screenshots/setup-1-settings-row.png)
...
![設定画面](screenshots/row-settings.png)
...
このアプリはストアで配布していないため、更新は自分で行う必要があります。メイン画面の「設定」行にある **アップデートを確認** から、新しいバージョンの確認・ダウンロード・インストールまでをアプリの中で済ませられます。
