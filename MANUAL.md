...
| ○○ から再生 | 前回やめた位置まで飛びます。**最初からこちらにフォーカスが当たっている**ので、決定を押すだけで続きから見られます。 |

「○○ から再生」のボタンには、飛び先の時刻がそのまま入ります（`12:34 から再生` / 1時間を超える位置なら `1:23:45 から再生`）。前回どこまで見たか覚えていなくても、押す前に飛び先が分かります。
...
| ○○ から再生 | 確認せず、常に前回の位置から再生します | 前回停止位置から |
